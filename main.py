...
<svg width="1200" height="500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1">
  ...
  <g fill="white" font-family="Arial" font-size="20" clip-path="url(#rounded-clip)">
    ...
    {''.join([
        ...
        f'<image x="10" y="{80 + i * 40}" width="60" height="60" xlink:href="{artist["images"][0]["url"]}" clip-path="url(#circle-clip)"/>'
        f'<text x="80" y="{110 + i * 40}" font-size="20" fill="white" width="250" overflow="visible">{artist["name"]}</text>'
        f'</a>'
  ...
  <!-- Separatore -->
  <line x1="340" y1="20" x2="340" y2="480" stroke="white" stroke-width="2" clip-path="url(#rounded-clip)"/>
  ...
  <g fill="white" font-family="Arial" font-size="20" clip-path="url(#rounded-clip)">
    ...
    {''.join([
        ...
        f'<image x="360" y="{80 + i * 40}" width="60" height="60" xlink:href="{track["album"]["images"][0]["url"]}" clip-path="url(#circle-clip)"/>'
        f'<text x="430" y="{110 + i * 40}" font-size="20" fill="white" width="250" overflow="visible">{track["name"]}</text>'
        f'</a>'
  ...
  <!-- Separatore -->
  <line x1="680" y1="20" x2="680" y2="480" stroke="white" stroke-width="2" clip-path="url(#rounded-clip)"/>
  ...
  <g fill="white" font-family="Arial" font-size="20" clip-path="url(#rounded-clip)">
    ...
    {''.join([
        ...
        f'<image x="700" y="{80 + i * 40}" width="60" height="60" xlink:href="{track["track"]["album"]["images"][0]["url"]}" clip-path="url(#circle-clip)"/>'
        f'<text x="770" y="{110 + i * 40}" font-size="20" fill="white" width="250" overflow="visible">{track["track"]["name"]}</text>'
        f'</a>'
